...
function submitForm() {
  ...
  if (!document.getElementById("agree-terms").checked) {
    document.getElementById("agree-error").innerText = "You must agree to the terms and conditions to continue";
    return;
  }
  if (!document.getElementById("agree-privacy").checked) {
    document.getElementById("agree-error").innerText = "You must agree to the privacy policy to continue";
    return;
  }
  if (!document.getElementById("agree-early").checked) {
    document.getElementById("agree-error").innerText = "You must agree to the early access terms to continue";
    return;
  }
